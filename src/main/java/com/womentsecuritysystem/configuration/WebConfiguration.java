package com.womentsecuritysystem.configuration;
...
@Configuration
@ComponentScan("com.womentsecuritysystem")
@Slf4j
public class WebConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("com.womentsecuritysystem.entity");
